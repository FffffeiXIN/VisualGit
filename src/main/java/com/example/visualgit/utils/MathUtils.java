        ...
        list.sort(((o1, o2) -> {
            ...
            if (Integer.parseInt(time1.substring(0, 4)) < Integer.parseInt(time2.substring(0, 4))) return -1;
                ...
                if (Integer.parseInt(time1.substring(4, 6)) < Integer.parseInt(time2.substring(4, 6))) return -1;
                    ...
                    else if (Integer.parseInt(time1.substring(6, 8)) > Integer.parseInt(time2.substring(6, 8)))
                        return 1;
                    else {
                        if (Integer.parseInt(time1.substring(8, 10)) < Integer.parseInt(time2.substring(8, 10)))
                            return -1;
                        else if (Integer.parseInt(time1.substring(8, 10)) > Integer.parseInt(time2.substring(8, 10)))
                            return 1;
                        else {
                            if (Integer.parseInt(time1.substring(10, 12)) < Integer.parseInt(time2.substring(10, 12)))
                                return -1;
                            else if (Integer.parseInt(time1.substring(10, 12)) > Integer.parseInt(time2.substring(10, 12)))
                                return 1;
                            else {
